...
const _nativeWalletDescriptorRegex =
    /^((wpkh|pkh)\((\[([a-z0-9]{8})(\/[1-9]{2}h)*(\/([0-9]h|\*))*\])*([xyztuv]((pub|prv))[1-9A-HJ-NP-Za-km-z]{79,108})(\/[0-9]+)*(\/\*)?\))$/;
const _wrappedWalletDescriptorRegex =
    /^(sh\(wpkh\((\[([a-z0-9]{8})(\/[1-9]{2}h)*(\/([0-9]h|\*))*\])*([xyztuv]((pub|prv))[1-9A-HJ-NP-Za-km-z]{79,108})(\/[0-9]+)*(\/\*)?\)\))$/;
