        ...
        <SafeAreaView style={{backgroundColor: ColorScheme.Background.Primary}}>
            <View
                ...
                <View style={tailwind('w-full h-full items-center')}>
                    ...
                    <View
                        style={tailwind(
                            'justify-center w-full items-center mb-8',
                        )}>
                        <Text
                            style={[
                    ...
                    <View style={[tailwind('w-full mb-10')]}>
                        ...
                        <Text
                            style={[
                                tailwind(
                                    'w-3/6 text-sm self-center text-center',
                                ),
                                Font.MediumText,
                    ...
                    <View
                        style={[
                            tailwind(
                                'w-full absolute items-center justify-center',
                            ),
                            NativeBottomPadding,
                        ]}>
                        <TouchableOpacity
                            ...
                            <View
                                style={tailwind('flex-row items-center mb-6')}>
                                <Github
                                    width={32}
                                    fill={ColorScheme.SVG.Default}
                                    style={tailwind('mr-2')}
