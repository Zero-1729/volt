...
import {getDescriptorParts} from './../../modules/wallet-utils';
import {BDKWalletTypeNames} from './../../modules/wallet-defaults';
...
describe('testing descriptor type extraction', () => {
    test('descriptor type matches', () => {
        ...
        const parts = getDescriptorParts(descriptor);

        expect(BDKWalletTypeNames[parts.type]).toBe(descriptor_type);
    });
});
